...
class testDemo2 extends AnyFunSpec:
  ...
  describe("Tests for apply Disaster") {
    ...
    it("population is changed IceAge") {
      ...
      print("changed population end \n")
      assertResult(false)(populationDinoIceAge(0).testLifePoints == populationDisIceAge(0).testLifePoints)
      assertResult(false)(populationDinoIceAge(1).testLifePoints == populationDisIceAge(1).testLifePoints)
      assertResult(false)(populationDinoIceAge(2).testLifePoints == populationDisIceAge(2).testLifePoints)
      assertResult(false)(populationDinoIceAge(3).testLifePoints == populationDisIceAge(3).testLifePoints)
      assertResult(false)(populationDinoIceAge(4).testLifePoints == populationDisIceAge(4).testLifePoints)
      assertResult(false)(populationDinoIceAge(5).testLifePoints == populationDisIceAge(5).testLifePoints)
    ...
    it("population is changed Drought") {
      ...
      print("changed population end \n")
      assertResult(false)(populationDinoDrought(0).testLifePoints == populationDisDrought(0).testLifePoints)
      assertResult(false)(populationDinoDrought(1).testLifePoints == populationDisDrought(1).testLifePoints)
      assertResult(false)(populationDinoDrought(2).testLifePoints == populationDisDrought(2).testLifePoints)
      assertResult(false)(populationDinoDrought(3).testLifePoints == populationDisDrought(3).testLifePoints)
      assertResult(false)(populationDinoDrought(4).testLifePoints == populationDisDrought(4).testLifePoints)
      assertResult(false)(populationDinoDrought(5).testLifePoints == populationDisDrought(5).testLifePoints)
    }
  }
