...
def createDemoSingleRandomDisaster(): List[Disaster] =
  ...
  val disasterSingleRandom = new ListBuffer[Disaster]()

  val rand = new Random(System.currentTimeMillis())
  val random_index = rand.nextInt(disArrayNoProb.length)
  val resultRand = disArrayNoProb(random_index)
  disasterSingleRandom += resultRand

  val dTestRandom = disasterSingleRandom.toList
